...
class Contract {
      ...
      verify: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined)) {
          __compactRuntime.type_error('verify',
                                      ...
                                      'verifier.compact line 27 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        }
        ...
        const result_0 = this._verify_0(context, partialProofData, id_0);
  ...
  _getSecret_0(context, partialProofData) {
    ...
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0 && result_0 <= __compactRuntime.MAX_FIELD)) {
      __compactRuntime.type_error('getSecret',
                                  'return value',
                                  'verifier.compact line 24 char 1',
                                  'Field',
                                  result_0)
    }
  ...
  _verify_0(context, partialProofData, id_0) {
    const secret_0 = this._getSecret_0(context, partialProofData);
    __compactRuntime.assert(this._equal_0(this._persistentHash_0(secret_0), id_0),
                            'Invalid secret');
    const tmp_0 = 1n;
    Contract._query(context,
                    partialProofData,
...
const _dummyContract = new Contract({ getSecret: (...args) => undefined });
const pureCircuits = {};

...
import { Verifier, type VerifierPrivateState, witnesses } from '@midnight-ntwrk/verifier-contract';
...
export const verify = async (verifierContract: DeployedVerifierContract, id: string): Promise<FinalizedTxData> => {
...
export const configureProviders = async (wallet: Wallet & Resource, config: Config) => {
  ...
  return {
    ...
    zkConfigProvider: new NodeZkConfigProvider<'verify'>(contractConfig.zkConfigPath),
